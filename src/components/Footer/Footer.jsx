  ...
  return (
    <>
      <div className="mobileFooter">
        <ul>
          <li>
          <img src="https://img.icons8.com/ios/50/null/home--v1.png"/>
            <span>Home</span>
          </li>
          <li>
          ...
          <li>
            <img src="https://img.icons8.com/ios/50/null/shopping-bag--v1.png" />
            <span>Korzinka</span>
          </li>
          <li>
            <img src="https://img.icons8.com/ios/50/null/gender-neutral-user--v1.png" />
            <span>Profil</span>
          </li>
        </ul>
      </div>
